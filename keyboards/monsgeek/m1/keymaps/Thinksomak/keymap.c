...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_all( /* Base */
        ...
        _______, _______, _______,                   _______,                            _______,MO(_FN2),_______,          KC_A,    KC_S,    KC_D),
    ...
    [_FN2] = LAYOUT_all( /* WASD/↑←↓→ */
        ...
        _______, _______,TG(_FN1),_______, _______, _______, _______, _______, KC_INS,  DF(_FN3),KC_PSCR,_______, _______, RM_NEXT,           _______,
    ...
    [_FN3] = LAYOUT_all( /* Base */
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,KC_NUHS,  KC_ENT,           KC_PGDN,
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,                             KC_RGUI, MO(_FN5),KC_RCTL,        KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN4] = LAYOUT_all( /* WASD/↑←↓→ */
        ...
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_W,    _______,
        _______, _______, _______,                   _______,                            _______, MO(_FN5), _______,          KC_A,    KC_S,    KC_D),
